(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["mtwtfss-calendar"] = factory(require("react"));
	else
		root["mtwtfss-calendar"] = factory(root["React"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dayView = __webpack_require__(104);
	
	var _dayView2 = _interopRequireDefault(_dayView);
	
	var _monthView = __webpack_require__(107);
	
	var _monthView2 = _interopRequireDefault(_monthView);
	
	var _yearView = __webpack_require__(108);
	...
	module.exports = _react2['default'].createClass({
	    ...
	    propTypes: {
	        ...
	        alwaysVisible: _react2['default'].PropTypes.bool,
	        weekdays: _react2['default'].PropTypes.arrayOf(_react2['default'].PropTypes.string),
	        weekStartsOn: _react2['default'].PropTypes.oneOf([0, 1, 2, 3, 4, 5, 6])
	    },
	    ...
	    prevView: function prevView(date) {
	        ...
	        if (this.state.currentView === this.state.minView) {
	            this.setState({
	                ...
	                isVisible: this.state.alwaysVisible ? true : false
	            });
	    ...
	    setDate: function setDate(date, isDayView) {
	        ...
	        this.setState({
	            date: date,
	            inputValue: date.format(this.state.format),
	            isVisible: this.props.closeOnSelect && isDayView && !this.state.alwaysVisible ? !this.state.isVisible : this.state.isVisible
	        });
	    ...
	    documentClick: function documentClick() {
	        if (!this.isCalendar && !this.state.alwaysVisible) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _cell = __webpack_require__(105);
	
	var _cell2 = _interopRequireDefault(_cell);
	
	var _viewHeader = __webpack_require__(106);
	    ...
	    _createClass(DayView, [{
	        ...
	        value: function render() {
	            if (this.props.weekStartsOn) {
	                _moment2['default'].locale(_moment2['default'].locale(), {
...
;
//# sourceMappingURL=mtwtfss-calendar.js.map